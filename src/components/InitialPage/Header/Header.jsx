    ...
    return (
        <header className="p-0">
            ...
            <div style = {{gap: "100px"}} className="cards d-flex align-items-center justify-content-center flex-nowrap m-0 p-0 w-100">
                <PlayingCard cardData={initialCard1} cardDimensions = {{width: "12.1875rem", height: "17.75rem"}} isInteractive = {true} onSelect = {() => {}}/>
                <PlayingCard cardData={initialCard2} cardDimensions = {{width: "12.1875rem", height: "17.75rem"}} isInteractive = {true}  onSelect = {() => {}}/>
            </div>
        </header>
    );
}
